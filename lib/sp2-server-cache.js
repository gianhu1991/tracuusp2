  ...
  while (true) {
    ...
    for (const row of data) {
      ...
      for (const item of list) {
        ...
        const dungLuongRaw = pickFirstDefined(item, ['DUNG_LUONG', 'DUNG_LUONG_TOI_DA', 'SO_CONG', 'TONG_CONG', 'SUC_CHUA']);
        const daDungRaw = pickFirstDefined(item, ['DA_DUNG', 'SO_DA_DUNG', 'SL_DA_DUNG', 'SO_CONG_DA_DUNG', 'DA_SU_DUNG', 'USED']);
        const chuaDungRaw = pickFirstDefined(item, ['CHUA_DUNG', 'SO_CHUA_DUNG', 'SL_CHUA_DUNG', 'SO_CONG_CHUA_DUNG', 'CON_LAI', 'AVAILABLE']);
        ...
        rows.push({
          ...
          daDung,
          chuaDung,
          ngayCapNhat: pickFirstDefined(item, ['NGAY_CAP_NHAT', 'NGAY_CN', 'UPDATED_AT', 'ngayCapNhat']) ?? '',
